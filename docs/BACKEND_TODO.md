...
- [ ] protected context синхронизирован отдельным PR только там, где это согласовано;
...
- [x] Protected context не изменён.
